...
class myGNN(torch.nn.Module):
    ...
    def __init__(self, task, hidden_channels: int, num_layers: int, 
        ...
        if True: # walking gait tasks
            ...
            |-------|-----------|----------------|---------------------------|
            | 0     | base      |  *range(9)     | *range(8), *range(20, 25) |
            | 1     | FL-hip    |  9, 21, 33     |  6, 7, 8, 26, 28, 30      |
            | 2     | FL-thigh  | 10, 22, 34     |  6, 7, 9, 26, 28, 30      |
            | 3     | FL-knee   | 11, 23, 35     | 6, 7, 10, 26, 28, 30      |
            | 4     | FR-hip    | 12, 24, 36     | 6, 7, 11, 25, 27, 29      |
            | 5     | FR-thigh  | 13, 25, 37     | 6, 7, 12, 25, 27, 29      |
            | 6     | FR-knee   | 14, 26, 38     | 6, 7, 13, 25, 27, 29      |
            | 7     | RL-hip    | 15, 27, 39, 45 | 6, 7, 14, 31, 33          |
            | 8     | RL-thigh  | 16, 28, 40, 45 | 6, 7, 15, 31, 33          |
            | 9     | RL-knee   | 17, 29, 41, 45 | 6, 7, 16, 31, 33          |
            | 10    | RR-hip    | 18, 30, 42, 46 | 6, 7, 17, 32, 34          |
            | 11    | RR-thigh  | 19, 31, 43, 46 | 6, 7, 18, 32, 34          |
            | 12    | RR-knee   | 20, 32, 44, 46 | 6, 7, 19, 32, 34          |
            '''
            self.num_timesteps = 3
            self.dim_common_obs = 47
            self.node_dict = {
                0: {'name': 'base', 'common': [*range(9)], 'privileged': [*range(8), *range(20, 25)]},
                1: {'name': 'FL-hip', 'common': [9, 21, 33], 'privileged': [6, 7, 8, 26, 28, 30]},
                2: {'name': 'FL-thigh', 'common': [10, 22, 34], 'privileged': [6, 7, 9, 26, 28, 30]},
                3: {'name': 'FL-knee', 'common': [11, 23, 35], 'privileged': [6, 7, 10, 26, 28, 30]},
                4: {'name': 'FR-hip', 'common': [12, 24, 36], 'privileged': [6, 7, 11, 25, 27, 29]},
                5: {'name': 'FR-thigh', 'common': [13, 25, 37], 'privileged': [6, 7, 12, 25, 27, 29]},
                6: {'name': 'FR-knee', 'common': [14, 26, 38], 'privileged': [6, 7, 13, 25, 27, 29]},
                7: {'name': 'RL-hip', 'common': [15, 27, 39, 45], 'privileged': [6, 7, 14, 31, 33]},
                8: {'name': 'RL-thigh', 'common': [16, 28, 40, 45], 'privileged': [6, 7, 15, 31, 33]},
                9: {'name': 'RL-knee', 'common': [17, 29, 41, 45], 'privileged': [6, 7, 16, 31, 33]},
                10: {'name': 'RR-hip', 'common': [18, 30, 42, 46], 'privileged': [6, 7, 17, 32, 34]},
                11: {'name': 'RR-thigh', 'common': [19, 31, 43, 46], 'privileged': [6, 7, 18, 32, 34]},
                12: {'name': 'RR-knee', 'common': [20, 32, 44, 46], 'privileged': [6, 7, 19, 32, 34]},
            }
            self.node_type_dict = {
